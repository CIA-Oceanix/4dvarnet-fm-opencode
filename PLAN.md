...
methods (Strong-4DVar, L1b/L2b/L4/L5/L6) show N=1 MAE ES (marked `*`). Remaining
L96 baseline caches (legacy int100/int200, fw, dws50) are still being regenerated by
