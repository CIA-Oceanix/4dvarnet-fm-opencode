...
| L1b |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
| L2b | 0.6329 | 0.4187 | 0.7399 | 0.6334 | 0.4153 | 0.7425 | 1.001 |
| L3 |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
| L4 |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
| L5 |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
| L6 | 0.6389 | 0.4136 | 0.7515 | 0.6380 | 0.4097 | 0.7521 | 0.999 |
| V2 |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
| V3 |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
| SDA1 | 0.7185 | 0.4431 | 0.8562 | 0.7168 | 0.4387 | 0.8558 | 0.998 |
| SDA2-mixed | 0.7074 | 0.3863 | 0.8679 | 0.7051 | 0.3803 | 0.8674 | 0.997 |
| SDA2-nominal | 0.7046 | 0.3801 | 0.8668 | 0.7033 | 0.3763 | 0.8669 | 0.998 |
| FDV1 |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
| FDV1CFM |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
| FDV1+SDA1 |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
| FDV1+SDA2 |   —   |   —   |   —   |   —   |   —   |   —   | n/a |
...
| L1b |   —   |   —   |   —   |   —   |   —   |   —   |
| L2b | 0.8527 | 0.9530 | 0.8026 | 0.8511 | 0.9525 | 0.8004 |
| L3 |   —   |   —   |   —   |   —   |   —   |   —   |
| L4 |   —   |   —   |   —   |   —   |   —   |   —   |
| L5 |   —   |   —   |   —   |   —   |   —   |   —   |
| L6 | 0.8490 | 0.9541 | 0.7964 | 0.8481 | 0.9538 | 0.7952 |
| V2 |   —   |   —   |   —   |   —   |   —   |   —   |
| V3 |   —   |   —   |   —   |   —   |   —   |   —   |
| SDA1 | 0.8062 | 0.9474 | 0.7357 | 0.8055 | 0.9470 | 0.7348 |
| SDA2-mixed | 0.8055 | 0.9600 | 0.7283 | 0.8050 | 0.9602 | 0.7274 |
| SDA2-nominal | 0.8064 | 0.9613 | 0.7290 | 0.8056 | 0.9610 | 0.7279 |
| FDV1 |   —   |   —   |   —   |   —   |   —   |   —   |
| FDV1CFM |   —   |   —   |   —   |   —   |   —   |   —   |
| FDV1+SDA1 |   —   |   —   |   —   |   —   |   —   |   —   |
| FDV1+SDA2 |   —   |   —   |   —   |   —   |   —   |   —   |
...
| L1b |   —  * |   —  * |   —  * |   —  * |   —  * |   —  * |
| L2b | 0.4056* | 0.2867* | 0.4650* | 0.4069* | 0.2849* | 0.4679* |
| L3 |   —   |   —   |   —   |   —   |   —   |   —   |
| L4 |   —  * |   —  * |   —  * |   —  * |   —  * |   —  * |
| L5 |   —  * |   —  * |   —  * |   —  * |   —  * |   —  * |
| L6 | 0.4068* | 0.2813* | 0.4695* | 0.4071* | 0.2803* | 0.4705* |
| V2 |   —   |   —   |   —   |   —   |   —   |   —   |
| V3 |   —   |   —   |   —   |   —   |   —   |   —   |
| SDA1 | 0.4711 | 0.3164 | 0.5484 | 0.4708 | 0.3126 | 0.5499 |
| SDA2-mixed | 0.4541 | 0.2754 | 0.5435 | 0.4524 | 0.2694 | 0.5440 |
| SDA2-nominal | 0.4535 | 0.2702 | 0.5451 | 0.4529 | 0.2650 | 0.5468 |
| FDV1 |   —  * |   —  * |   —  * |   —  * |   —  * |   —  * |
| FDV1CFM |   —   |   —   |   —   |   —   |   —   |   —   |
| FDV1+SDA1 |   —   |   —   |   —   |   —   |   —   |   —   |
| FDV1+SDA2 |   —   |   —   |   —   |   —   |   —   |   —   |
