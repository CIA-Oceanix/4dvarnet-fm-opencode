...
3. **Family ranking under the benchmark default**: DirectUNet-M 0.380 ± 0.004 < PredictStateCFM-M 0.409 ± 0.007 < VanillaCFM-M 0.434 ± 0.006 (regular S0; the same order on the random set). The P1 ranking, where the flows led, does not survive fair training: P1's DirectUNet was overfitting frozen per-window obs noise.
4. **P1 fixed-obs checkpoints do not transfer**: best on the regular grid for the flows, but DirectUNet-M x3.3, PredictStateCFM-M x2.8, VanillaCFM-M x3.0 on the random set, against x1.25-1.30 for the benchmark-default models.
...
| Benchmark default | PredictStateCFM-M | 3 | 0.409 ± 0.007 | 0.406 ± 0.007 | 0.520 ± 0.007 | 0.526 ± 0.005 | 1.27 | 0.99 |
| Benchmark default | VanillaCFM-M | 3 | 0.434 ± 0.006 | 0.431 ± 0.004 | 0.543 ± 0.002 | 0.553 ± 0.004 | 1.25 | 0.99 |
| P1 fixed obs | DirectUNet-M | 1 | 0.470 | 0.471 | 1.547 | 1.513 | 3.29 | 1.00 |
| P1 fixed obs | PredictStateCFM-M | 1 | 0.358 | 0.355 | 0.998 | 0.977 | 2.78 | 0.99 |
| P1 fixed obs | VanillaCFM-M | 1 | 0.344 | 0.339 | 1.028 | 1.016 | 2.98 | 0.98 |
...
|---|---|---|---|---|---|
| Benchmark default | PredictStateCFM-M | 0.191 ± 0.003 | 0.243 ± 0.003 | 0.534 | 0.517 |
| Benchmark default | VanillaCFM-M | 0.201 ± 0.004 | 0.251 ± 0.002 | 0.617 | 0.587 |
| P1 fixed obs | PredictStateCFM-M | 0.173 | 0.581 | 0.400 | 0.246 |
| P1 fixed obs | VanillaCFM-M | 0.157 | 0.612 | 0.535 | 0.259 |
