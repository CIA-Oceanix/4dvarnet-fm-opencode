...
\subsubsection{Conditioning on model information is nearly inert}
\label{sec:inert}
...
\subsubsection{ODE sensitivity is not posterior sensitivity}
...
\subsubsection{Weak-constraint 4D-Var bounds the claim}
\label{sec:weak4dvar}
