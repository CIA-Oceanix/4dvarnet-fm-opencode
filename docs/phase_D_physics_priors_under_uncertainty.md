...
positioning sections of `docs/research_notes_cfm_da_originality_and_benchmarking.md`
...
Gaussianity, and `docs/cfm_affine_velocity_decomposition.md` measured that
