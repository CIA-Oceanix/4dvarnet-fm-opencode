...
| `cfm_tau_consistency_next_steps.md` | **DRAFT**, v2 2026-09-23. Plan re-derived from the tower property: a truth-marginal consistency test first (NS1), then bootstrapped τ=0 targets (T2a), low-τ sampling (T1), a pairwise martingale target (T2b), with the B4 penalty (T3) and a structural mean slot (T4) as fallbacks. Measured defects in `docs/results/cfm_tau_consistency.md`. Nothing implemented; decisions in §6. |
