...
| `cfm_tau_consistency_next_steps.md` | **CLOSED** 2026-09-25 (last revision v4). Outcomes, the one identified model failure (PredictStateCFM's late-τ Jacobian) and open items are in `docs/results/cfm_tau_consistency_synthesis.md`. |
