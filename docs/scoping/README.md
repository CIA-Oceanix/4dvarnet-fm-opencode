...
| `cgoa_coupled_gyrostat_case_study.md` | **SCOPING** v2 2026-09-24 (v2 revised §5: built on shared, extracted pieces instead of mirroring the L96 stack). A fourth case study: coupled ocean–atmosphere from coupled gyrostats (Tier A), plus MAOOAM through qgs (Tier B), on one quadratic-tensor torch engine. Nothing implemented. Paper fit (P1 / P2 / standalone) is open, §9. |
